...
// home.js - নিচে এই ফাংশনগুলো যোগ করুন (আগের কোডের সাথে মিলিয়ে নিন)

// ============================================
// ADD THESE FUNCTIONS AT THE END OF home.js
// ============================================
...
window.goToAdminLogin = function() {
    window.location.href = 'admin-login.html';
};
...
window.markAllNotificationsRead = function() {
    ...
    const dropdownBody = document.getElementById('notificationDropdownBody');
    if (dropdownBody) {
        dropdownBody.innerHTML = '<div class="empty-notifications"><i class="fas fa-check-circle"></i><p>No notifications</p><small>All caught up!</small></div>';
    }
};